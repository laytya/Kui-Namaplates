...
local GetTime, floor, ceil, fmod, getn = GetTime,  math.floor, math.ceil, math.mod, table.getn
...
--	Sea.io.printTable2({e=e,u=u,arg1=arg1})
...
--	self:RegisterMessage('KuiNameplates_PostTarget', 'PLAYER_TARGET_CHANGED')
	...
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_CREATURE_DAMAGE",       function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_CREATURE_BUFFS",        function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_HOSTILEPLAYER_BUFFS",   function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_HOSTILEPLAYER_DAMAGE",  function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_SELF_BUFFS",            function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_SELF_DAMAGE",           function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_FRIENDLYPLAYER_BUFFS",  function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
	mod.parser:RegisterEvent("KNP_Auras", "CHAT_MSG_SPELL_PERIODIC_FRIENDLYPLAYER_DAMAGE", function (event, info) self:COMBAT_LOG_EVENT(event, info) end)
...
function mod:OnDisable()
	...
	parser:UnregisterAllEvents("KNP_Auras")
